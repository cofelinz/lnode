...
//	static int mt_gc_function(lua_State* ls_)
//	{
//		if (lua_isuserdata(ls_, 1))
//		{
//			CLASS_TYPE * *p = userdata_to_object_ptr_address(ls_);
//			if (p)
//			{
//				delete *p;
//				*p = 0;
...
public:
	...
	{
		lua_function_t class_function = exception_safe_tool<&class_function_traits_t<FUNC_TYPE>::lua_function>::f;
	...
	void enable_gc()
	{
		...
		lua_function_t gc_function = exception_safe_tool<&delete_traits_t<CLASS_TYPE>::lua_function>::f;
		lua_pushcclosure(m_ls, gc_function, 0);
		lua_settable(m_ls, -3);

	}
	// 把一个静态函数添加到某个类下面，Lua中可以用Class.func调用它
	template<typename FUNC>
	fflua_register_t& add_static_func(FUNC func_, const string& func_name_)
	{
		lua_getglobal(m_ls, m_class_name.c_str());
		lua_pushstring(m_ls, func_name_.c_str());
		push_cclosure(m_ls, func_);
		lua_settable(m_ls, -3);
	...
	fflua_register_t& add_raw_func(lua_CFunction func_, const string& func_name_)
	{
		lua_getglobal(m_ls, m_class_name.c_str());
		lua_pushstring(m_ls, func_name_.c_str());
	...
	// 添加一个全局函数
	template<typename FUNC>
	static void add_global_func(lua_State * L, FUNC func_, const string& func_name_)
	{
		push_cclosure(L, func_);
		lua_setglobal(L, func_name_.c_str());
	}

	// 添加一个全局函数
	template<typename FUNC>
	fflua_register_t& add_global_func(FUNC func_, const string& func_name_)
	{
		add_global_func(m_ls, func_, func_name_);
		return *this;
	}
private:
	lua_State* 	m_ls;
	...
	template<typename FUNC>
	static void push_cclosure(lua_State * L, FUNC func_)
	{
		lua_function_t lua_func = exception_safe_tool<function_traits_t<FUNC>::lua_function>::f;
		void* user_data_ptr = lua_newuserdata(L, sizeof(func_));
		new (user_data_ptr) FUNC(func_);
		lua_pushcclosure(L, lua_func, 1);
	}
};
	...
	m_class_name(class_name_)
{
	...
	lua_function_t index_function = exception_safe_tool<&metatable_register_impl_t<CLASS_TYPE>::mt_index_function>::f;
	lua_pushcclosure(ls_, index_function, 0);
	lua_settable(ls_, -3);

	lua_pushstring(ls_, "get_pointer");
	lua_function_t pointer_function = exception_safe_tool<&metatable_register_impl_t<CLASS_TYPE>::get_pointer>::f;
	lua_pushcclosure(ls_, pointer_function, 0);
	lua_settable(ls_, -3);

	lua_pushstring(ls_, "__newindex");
	lua_function_t newindex_function = exception_safe_tool<&metatable_register_impl_t<CLASS_TYPE>::mt_newindex_function>::f;
	lua_pushcclosure(ls_, newindex_function, 0);
	lua_settable(ls_, -3);

	lua_function_t function_for_new = exception_safe_tool<&new_traits_t<CLASS_TYPE, CTOR_TYPE>::lua_function>::f;
	...
	lua_function_t function_for_delete = exception_safe_tool<&delete_traits_t<CLASS_TYPE>::lua_function>::f;
...
struct new_traits_t<CLASS_TYPE, void(ARG1)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG1>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(2), arg1);
...
struct new_traits_t<CLASS_TYPE, void(ARG1, ARG2)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG1>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(2), arg1);
        lua_op_t<typename reference_traits_t<ARG2>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(3), arg2);
...
struct new_traits_t<CLASS_TYPE, void(ARG1, ARG2, ARG3)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG1>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(2), arg1);
        lua_op_t<typename reference_traits_t<ARG2>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(3), arg2);
        lua_op_t<typename reference_traits_t<ARG3>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(4), arg3);
...
struct new_traits_t<CLASS_TYPE, void(ARG1, ARG2, ARG3, ARG4)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG2>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(3), arg2);
        lua_op_t<typename reference_traits_t<ARG3>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(4), arg3);
        lua_op_t<typename reference_traits_t<ARG4>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(5), arg4);
                                               ...
                                               ARG5)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG3>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(4), arg3);
        lua_op_t<typename reference_traits_t<ARG4>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(5), arg4);
        lua_op_t<typename reference_traits_t<ARG5>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(6), arg5);
                                               ...
                                               ARG4, ARG5, ARG6)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG4>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(5), arg4);
        lua_op_t<typename reference_traits_t<ARG5>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(6), arg5);
        lua_op_t<typename reference_traits_t<ARG6>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(7), arg6);
                                               ...
                                               ARG4, ARG5, ARG6, ARG7)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG5>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(6), arg5);
        lua_op_t<typename reference_traits_t<ARG6>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(7), arg6);
        lua_op_t<typename reference_traits_t<ARG7>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(8), arg7);
                                               ...
                                               ARG4, ARG5, ARG6, ARG7, ARG8)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG6>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(7), arg6);
        lua_op_t<typename reference_traits_t<ARG7>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(8), arg7);
        lua_op_t<typename reference_traits_t<ARG8>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(9), arg8);
                                               ...
                                               ARG4, ARG5, ARG6, ARG7, ARG8, ARG9)>
{
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG7>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(8), arg7);
        lua_op_t<typename reference_traits_t<ARG8>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(9), arg8);
        lua_op_t<typename reference_traits_t<ARG9>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(10), arg9);
...
struct class_property_traits_t
{
	...
	static int process_newindex(lua_State* ls_, void* field_info_, const char* key_, int value_index_)
	{
		...
		if (ptr)
		{
			...
			lua_op_t<property_t>::get_value_check(ls_, value_index_, value);
			(obj_ptr->*ptr) = value;
			return 0;
		}
		else
...
struct function_traits_t<void(*)(ARG1)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG1>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(1), arg1);
...
struct function_traits_t<void(*)(ARG1, ARG2)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG1>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(1), arg1);
        lua_op_t<typename reference_traits_t<ARG2>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(2), arg2);
...
struct function_traits_t<void(*)(ARG1, ARG2, ARG3)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG1>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(1), arg1);
        lua_op_t<typename reference_traits_t<ARG2>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(2), arg2);
        lua_op_t<typename reference_traits_t<ARG3>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(3), arg3);
...
struct function_traits_t<void (*)(ARG1, ARG2, ARG3, ARG4)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG2>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(2), arg2);
        lua_op_t<typename reference_traits_t<ARG3>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(3), arg3);
        lua_op_t<typename reference_traits_t<ARG4>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(4), arg4);
...
struct function_traits_t<void (*)(ARG1, ARG2, ARG3, ARG4, ARG5)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG3>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(3), arg3);
        lua_op_t<typename reference_traits_t<ARG4>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(4), arg4);
        lua_op_t<typename reference_traits_t<ARG5>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(5), arg5);
...
struct function_traits_t<void (*)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG4>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(4), arg4);
        lua_op_t<typename reference_traits_t<ARG5>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(5), arg5);
        lua_op_t<typename reference_traits_t<ARG6>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(6), arg6);
...
struct function_traits_t<void (*)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG5>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(5), arg5);
        lua_op_t<typename reference_traits_t<ARG6>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(6), arg6);
        lua_op_t<typename reference_traits_t<ARG7>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(7), arg7);
...
struct function_traits_t<void (*)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG6>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(6), arg6);
        lua_op_t<typename reference_traits_t<ARG7>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(7), arg7);
        lua_op_t<typename reference_traits_t<ARG8>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(8), arg8);
...
struct function_traits_t<void (*)(ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7, ARG8, ARG9)>
{
    ...
    static  int lua_function(lua_State* ls_)
    {
        ...
        lua_op_t<typename reference_traits_t<ARG7>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(7), arg7);
        lua_op_t<typename reference_traits_t<ARG8>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(8), arg8);
        lua_op_t<typename reference_traits_t<ARG9>::arg_type_t>::get_value_check(ls_, LUA_ARG_POS(9), arg9);
