...
struct lua_op_t<const char*>
{
    ...
    static int get_value_check(lua_State* ls_, int pos_, char*& param_)
    {
...
{
    static int get_value_nothrow(lua_State* ls_, int pos_, cpp_void_t& param_)
    {
        return 0;
    }
};
...
struct lua_op_t<int64_t>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, int64_t& param_)
    {
    ...
    static int get_value_check(lua_State* ls_, int pos_, int64_t& param_)
    {
        size_t len = 0;
...
template<> struct lua_op_t<uint64_t>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, uint64_t& param_)
    {
        if (!lua_isstring(ls_, pos_))
        {
            return -1;
    ...
    static int get_value_check(lua_State* ls_, int pos_, uint64_t& param_)
    {
        size_t len = 0;
        const char* str = luaL_checklstring(ls_, pos_, &len);
...
template<> struct lua_op_t<int8_t>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, int8_t& param_)
	{
	...
	static int get_value_check(lua_State* ls_, int pos_, int8_t& param_)
	{
...
struct lua_op_t<uint8_t>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, uint8_t& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, uint8_t& param_)
	{
...
template<> struct lua_op_t<int16_t>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, int16_t& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, int16_t& param_)
	{
...
template<> struct lua_op_t<uint16_t>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, uint16_t& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, uint16_t& param_)
	{
...
template<> struct lua_op_t<int32_t>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, int32_t& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, int32_t& param_)
	{
...
template<> struct lua_op_t<uint32_t>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, uint32_t& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, uint32_t& param_)
	{
...
struct lua_op_t<bool>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, bool& param_)
    {
    	//! nil 自动转换为false
    ...
    static int get_value_check(lua_State* ls_, int pos_, bool& param_)
    {
...
struct lua_op_t<string>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, string& param_)
    {
        if (!lua_isstring(ls_, pos_))
        {
            return -1;
    ...
    static int get_value_check(lua_State* ls_, int pos_, string& param_)
    {
        size_t len = 0;
        const char* str = luaL_checklstring(ls_, pos_, &len);
...
template<> struct lua_op_t<float>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, float& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, float& param_)
	{
...
template<> struct lua_op_t<double>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, double& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, double& param_)
	{
...
/*template<> struct lua_op_t<long>
{
	...
	static int get_value_nothrow(lua_State* ls_, int pos_, long& param_)
	{
		if (!lua_isnumber(ls_, pos_))
		{
			return -1;
	...
	static int get_value_check(lua_State* ls_, int pos_, long& param_)
	{
...
struct lua_op_t<void*>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, void* & param_)
    {
    ...
    static int get_value_check(lua_State* ls_, int pos_, void*& param_)
    {
        if (!lua_isuserdata(ls_, pos_))
        {
...
struct lua_op_t<T*>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, T* & param_)
    {
        if (false == lua_type_info_t<T>::is_registed())
        {
            luaL_argerror(ls_, pos_, "type not supported, get_value_nothrow");
        }
    ...
    static int get_value_check(lua_State* ls_, int pos_, T*& param_)
    {
        if (false == lua_type_info_t<T>::is_registed())
        {
            luaL_argerror(ls_, pos_, "type not supported, get_value_check");
        }
        void *arg_data = lua_touserdata(ls_, pos_);
...
struct lua_op_t<const T*>
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, T* & param_)
    {
       return lua_op_t<T*>::get_value_nothrow(ls_, pos_, param_);
    }

    static int get_value_check(lua_State* ls_, int pos_, T*& param_)
    {
        return lua_op_t<T*>::get_value_check(ls_, pos_, param_);
    }
};
...
struct lua_op_t<vector<T> >
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, vector<T>& param_)
    {
		...
		{
			param_.push_back(T());
			if (lua_op_t<T>::get_value_nothrow(ls_, -1, param_[param_.size() - 1]) < 0)
			{
				return -1;
			}
			lua_pop(ls_, 1);
    ...
    static int get_value_check(lua_State* ls_, int pos_, vector<T>& param_)
    {
		...
		{
			param_.push_back(T());
			if (lua_op_t<T>::get_value_check(ls_, -1, param_[param_.size() - 1]) < 0)
			{
...
struct lua_op_t<list<T> >
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, list<T>& param_)
    {
    	if (0 == lua_istable(ls_, pos_))
    	{
    		return -1;
		...
		{
			param_.push_back(T());
			if (lua_op_t<T>::get_value_nothrow(ls_, -1, (param_.back())) < 0)
			{
				return -1;
			}
			lua_pop(ls_, 1);
    ...
    static int get_value_check(lua_State* ls_, int pos_, list<T>& param_)
    {
    	luaL_checktype(ls_, pos_, LUA_TTABLE);
		...
		{
			param_.push_back(T());
			if (lua_op_t<T>::get_value_check(ls_, -1, (param_.back())) < 0)
			{
				luaL_argerror(ls_, pos_>0?pos_:-pos_, "convert to vector failed");
			}
			lua_pop(ls_, 1);
...
struct lua_op_t<set<T> >
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, set<T>& param_)
    {
    	if (0 == lua_istable(ls_, pos_))
    	{
    		return -1;
		...
		while (lua_next(ls_, real_pos) != 0)
		{
			...
			if (lua_op_t<T>::get_value_nothrow(ls_, -1, val) < 0)
			{
				return -1;
			}
			param_.insert(val);
    ...
    static int get_value_check(lua_State* ls_, int pos_, set<T>& param_)
    {
    	luaL_checktype(ls_, pos_, LUA_TTABLE);
		...
		{
			T val = init_value_traits_t<T>::value();
			if (lua_op_t<T>::get_value_check(ls_, -1, val) < 0)
			{
				luaL_argerror(ls_, pos_>0?pos_:-pos_, "convert to vector failed");
			}
			param_.insert(val);
...
struct lua_op_t<map<K, V> >
{
    ...
    static int get_value_nothrow(lua_State* ls_, int pos_, map<K, V>& param_)
    {
    	if (0 == lua_istable(ls_, pos_))
    	{
    		return -1;
		...
		while (lua_next(ls_, real_pos) != 0)
		{
			...
			if (lua_op_t<K>::get_value_nothrow(ls_, -2, key) < 0 ||
				lua_op_t<V>::get_value_nothrow(ls_, -1, val) < 0)
			{
				return -1;
			}
    ...
    static int get_value_check(lua_State* ls_, int pos_, map<K, V>& param_)
    {
    	luaL_checktype(ls_, pos_, LUA_TTABLE);
